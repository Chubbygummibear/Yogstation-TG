...
/obj/item/twohanded/required/baseball_bat/attack(mob/living/target, mob/living/user)
	...
	if(homerun_ready)
		...
		target.safe_throw_at(throw_target, rand(1, 2), whack_speed, user, gentle = TRUE) // sorry friends, 7 speed batting caused wounds to absolutely delete whoever you knocked your target into (and said target)
