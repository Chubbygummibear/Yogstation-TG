...
/datum/preferences/proc/load_character(slot)
	...
	READ_FILE(S["feature_mcolor_accent"], features["mcolor_accent"])
	...
	features["mcolor_accent"]	= sanitize_hexcolor(features["mcolor_accent"], 3, 0)
...
/datum/preferences/proc/save_character()
	...
	WRITE_FILE(S["feature_mcolor_accent"]					, features["mcolor_accent"])
