...
/obj/item/reagent_containers/food/snacks/icecream
	...
	volume = 10 //The max volumes scales up with the number of scoops of ice cream served.
...
/obj/item/reagent_containers/food/snacks/icecream/Initialize(mapload, list/prefill_flavours)
	if(prefill_flavours)
	...
	return ..()
/obj/item/reagent_containers/food/snacks/icecream/chocolate
	name = "chocolate cone"
	desc = "Delicious chocolate cone, but no ice cream."
	icon_state = "icecream_cone_chocolate"
	bonus_reagents = list(/datum/reagent/consumable/nutriment = 4, /datum/reagent/consumable/coco = 1)
