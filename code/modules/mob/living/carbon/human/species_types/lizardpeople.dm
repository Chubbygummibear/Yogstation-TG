/datum/species/lizard
	...
	default_features = list("mcolor" = "0F0","mcolor_accent" = "0F0", "tail_lizard" = "Smooth", "snout" = "Round", "horns" = "None", "frills" = "None", "spines" = "None", "body_markings" = "None", "legs" = "Normal Legs")
