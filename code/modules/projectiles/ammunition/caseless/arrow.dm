...
/obj/item/ammo_casing/caseless/arrow/bola
	...
	projectile_type = /obj/projectile/bullet/reusable/arrow/bola
...
/obj/item/ammo_casing/caseless/arrow/bola/Initialize()
	...
	if(istype(A))
		...
		var/obj/projectile/bullet/reusable/arrow/AA = A.BB
		var/obj/projectile/bullet/reusable/arrow/BBB = BB
	...
	var/obj/projectile/bullet/reusable/arrow/bola/bola_arrow = BB
	if(!istype(bola))
		bola = new(src)
...
/obj/item/ammo_casing/caseless/arrow/explosive
	...
	projectile_type = /obj/projectile/bullet/reusable/arrow/explosive
...
/obj/item/ammo_casing/caseless/arrow/explosive/Initialize()
	...
	if(istype(A))
		icon = A.icon
		icon_state = A.icon_state
		var/obj/projectile/bullet/reusable/AA = A.BB
		var/obj/projectile/bullet/reusable/BBB = BB
		if(istype(AA) && istype(BBB))
			BBB.damage = AA.damage * 0.5
			BBB.armour_penetration = AA.armour_penetration * 0.5
			BBB.ammo_type = AA.ammo_type
	...
	var/obj/projectile/bullet/reusable/arrow/explosive/explosive_arrow = BB
	if(!istype(explosive))
...
/obj/item/ammo_casing/caseless/arrow/flaming
	...
	projectile_type = /obj/projectile/bullet/reusable/arrow/flaming
