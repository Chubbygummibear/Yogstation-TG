...
/obj/structure/destructible/clockwork/powered/clockwork_obelisk/examine(mob/user)
	...
	if(is_servant_of_ratvar(user) || isobserver(user))
		. += span_nzcrentr_small("It requires <b>[display_energy(hierophant_cost)]</b> to broadcast over the Hierophant Network, and <b>[display_energy(gateway_cost)]</b> to open a Spatial Gateway.")
